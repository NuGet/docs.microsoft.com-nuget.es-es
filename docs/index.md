...
layout: HubPage
hide_bc: True
title: "Documentación de NuGet | Microsoft Docs"
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>Experimente con NuGet con tutoriales específicos para crear un paquete sencillo y usar un paquete.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Guías</h3>
                                            <p>Experimente con las herramientas y capacidades de NuGet con tutoriales de instalación y creación de paquetes.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Directivas</h3>
                                            <p>Preguntas frecuentes junto con información sobre NuGet como proyecto de código abierto, eliminación de paquetes y resolución de conflictos.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
