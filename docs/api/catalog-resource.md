...
----------------------- | -------------------------- | -------- | -----
authors                 | cadena                     | No       |
created                 | cadena                     | No       | Una marca de tiempo de cuando se creó el paquete por primera vez. Propiedad reserva: `published`.
...
iconUrl                 | cadena                     | No       |
isPrerelease            | booleano                    | No       | Si la versión del paquete es una versión preliminar. Pueden detectarse en `version`.
lenguaje                | cadena                     | No       |
