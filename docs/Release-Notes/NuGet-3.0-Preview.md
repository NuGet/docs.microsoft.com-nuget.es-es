...
Entre ahora y 3.0 RTM, también estamos trabajando en algunas características fundamentales de NuGet nuevas, más allá de lo que verá en la interfaz de usuario. Esta es una lista breve de las áreas de inversión importantes:
