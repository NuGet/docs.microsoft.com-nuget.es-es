...
---
# <a name="40-rtm-release-notes"></a>Notas de la versión de 4.0 RTM
...
### <a name="msbuild-trestore-fails-when-a-project-targeting-net461-references-another-project-targeting-netstandard"></a>Se produce un error de `msbuild /t:restore` cuando un proyecto dirigido a .NET461 hace referencia a otro proyecto dirigido a .NET Standard
