...
## [Solución de problemas de paquetes instalados](concepts/troubleshooting-installed-packages.md)
# Referencia
## [.nuspec](reference/nuspec.md)
## [Archivo nuget.config](reference/nuget-config-file.md)
## [Marcos de trabajo de destino](reference/target-frameworks.md)
## [Empaquetado y restauración como destinos de MSBuild](reference/msbuild-targets.md)
...
## [Preguntas más frecuentes](resources/nuget-faq.yml)
