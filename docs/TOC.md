...
### [actualizar](tools/cli-ref-update.md)
...
## [Versiones de .NET Framework de destino](reference/target-frameworks.md)
...
## Contenido archivado
### [Formato de administración project.json](archive/project-json.md)
...
### [Buscar](api/search-query-service-resource.md)
...
## [API de NuGet en Visual Studio](visual-studio-extensibility/nuget-api-in-visual-studio.md)
...
## [Eliminar paquetes](policies/deleting-packages.md)
# Notas de la versión
