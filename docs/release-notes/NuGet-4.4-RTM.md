...
- dotnet
  - dotnet add package puede borrar las líneas vacías de un archivo csproj: [#5697](https://github.com/NuGet/Home/issues/5697)
...
- dotnet
  - dotnetcore pack se comporta de forma diferente en TargetFramework que en TargetFrameworks: [#5281](https://github.com/NuGet/Home/issues/5281)
...
## <a name="links-to-github-issues-fixed-in-44-rtm"></a>Vínculos a problemas de GitHub corregidos en 4.4 RTM
