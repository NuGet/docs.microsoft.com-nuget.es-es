...
---
# <a name="nuget-40-rc-release-notes"></a>Notas de la versión de NuGet 4.0 RC
...
- dotnet
  - dotnetcore pack3 debe incluir la documentación XML de forma predeterminada: [#3698](https://github.com/NuGet/Home/issues/3698)
...
- dotnet
  - La restauración de dotnetcore realiza búsquedas de identificador que distinguen mayúsculas de minúsculas en repositorios locales de lista plana cuando se usan versiones flotantes: [#2516](https://github.com/NuGet/Home/issues/2516)
...
- dotnet
  - dotnetcore restore3 foo.csproj debe seguir las dependencias de projectref y también restaurarlas. Igual que la compilación:[#3577](https://github.com/NuGet/Home/issues/3577)
