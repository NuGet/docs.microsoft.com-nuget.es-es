### <a name="priority-ordering"></a>Orden de prioridad

También puede servir de ayuda pensar en el "orden de prioridad" en el que se aplican las opciones de configuración, que es básicamente lo contrario al orden de procesamiento. Por ejemplo, si un proyecto se encuentra en `c:\A\B\C`, NuGet aplica las opciones de configuración en el siguiente orden de prioridad, lo que significa que las opciones de configuración que se encuentran primero tienen prioridad:
