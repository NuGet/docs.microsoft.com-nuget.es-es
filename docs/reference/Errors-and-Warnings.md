...
Los errores y las advertencias que se enumeran aquí solo están disponibles con proyectos [basados en PackageReference](../consume-packages/package-references-in-project-files.md) y NuGet 4.3.0 +. NuGet también respeta las propiedades de MSBuild para suprimir las advertencias o elevarlas a errores. Para obtener más información, vea [Cómo: Suprimir advertencias](/visualstudio/ide/how-to-suppress-compiler-warnings) del compilador en la documentación de Visual Studio.
