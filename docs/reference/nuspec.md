...
## <a name="general-form-and-schema"></a><span data-ttu-id="0f1d5-116">Esquema y forma general</span><span class="sxs-lookup"><span data-stu-id="0f1d5-116">General form and schema</span></span>
...
<span data-ttu-id="0f1d5-125">Estos elementos deben aparecer dentro de un elemento `<metadata>`.</span><span class="sxs-lookup"><span data-stu-id="0f1d5-125">These elements must appear within a `<metadata>` element.</span></span>
...
#### <a name="title"></a><span data-ttu-id="0f1d5-138">título</span><span class="sxs-lookup"><span data-stu-id="0f1d5-138">title</span></span>
...
#### <a name="iconurl"></a><span data-ttu-id="0f1d5-160">iconUrl</span><span class="sxs-lookup"><span data-stu-id="0f1d5-160">iconUrl</span></span>
...
<span data-ttu-id="0f1d5-176">*(1.5+)* Información de copyright del paquete.</span><span class="sxs-lookup"><span data-stu-id="0f1d5-176">*(1.5+)* Copyright details for the package.</span></span>
...
## <a name="replacement-tokens"></a><span data-ttu-id="0f1d5-222">Tokens de reemplazo</span><span class="sxs-lookup"><span data-stu-id="0f1d5-222">Replacement tokens</span></span>
...
| <span data-ttu-id="0f1d5-283">motor en tiempo de ejecución</span><span class="sxs-lookup"><span data-stu-id="0f1d5-283">runtime</span></span> | <span data-ttu-id="0f1d5-284">Runtime, Resources y FrameworkAssemblies</span><span class="sxs-lookup"><span data-stu-id="0f1d5-284">Runtime, Resources, and FrameworkAssemblies</span></span> |
...
- <span data-ttu-id="0f1d5-370">Imágenes que se insertan como recursos</span><span class="sxs-lookup"><span data-stu-id="0f1d5-370">Images that are embedded as resources</span></span>
...
<span data-ttu-id="0f1d5-391">*NuGet 4.0 + con PackageReference*</span><span class="sxs-lookup"><span data-stu-id="0f1d5-391">*NuGet 4.0+ with PackageReference*</span></span>
...
#### <a name="example-contentfiles-section"></a><span data-ttu-id="0f1d5-424">Sección contentFiles de ejemplo</span><span class="sxs-lookup"><span data-stu-id="0f1d5-424">Example contentFiles section</span></span>
...
## <a name="example-nuspec-files"></a><span data-ttu-id="0f1d5-425">Archivos de ejemplo de nuspec</span><span class="sxs-lookup"><span data-stu-id="0f1d5-425">Example nuspec files</span></span>

<span data-ttu-id="0f1d5-426">**Un archivo `.nuspec` simple que no especifica dependencias ni archivos**</span><span class="sxs-lookup"><span data-stu-id="0f1d5-426">**A simple `.nuspec` that does not specify dependencies or files**</span></span>
...
<span data-ttu-id="0f1d5-427">**Un archivo `.nuspec` con dependencias**</span><span class="sxs-lookup"><span data-stu-id="0f1d5-427">**A `.nuspec` with dependencies**</span></span>
...
<span data-ttu-id="0f1d5-428">**Un archivo `.nuspec` con archivos**</span><span class="sxs-lookup"><span data-stu-id="0f1d5-428">**A `.nuspec` with files**</span></span>
...
<span data-ttu-id="0f1d5-429">**Un archivo `.nuspec` con ensamblados de plataforma**</span><span class="sxs-lookup"><span data-stu-id="0f1d5-429">**A `.nuspec` with framework assemblies**</span></span>
...
<span data-ttu-id="0f1d5-430">En este ejemplo se instalan los siguientes componentes para los destinos de proyecto específicos:</span><span class="sxs-lookup"><span data-stu-id="0f1d5-430">In this example, the following are installed for specific project targets:</span></span>

- <span data-ttu-id="0f1d5-431">.NET4 -> `System.Web`, `System.Net`</span><span class="sxs-lookup"><span data-stu-id="0f1d5-431">.NET4 -> `System.Web`, `System.Net`</span></span>
- <span data-ttu-id="0f1d5-432">.NET4 Client Profile -> `System.Net`</span><span class="sxs-lookup"><span data-stu-id="0f1d5-432">.NET4 Client Profile -> `System.Net`</span></span>
- <span data-ttu-id="0f1d5-433">Silverlight 3 -> `System.Json`</span><span class="sxs-lookup"><span data-stu-id="0f1d5-433">Silverlight 3 -> `System.Json`</span></span>
- <span data-ttu-id="0f1d5-434">Silverlight 4 -> `System.Windows.Controls.DomainServices`</span><span class="sxs-lookup"><span data-stu-id="0f1d5-434">Silverlight 4 -> `System.Windows.Controls.DomainServices`</span></span>
- <span data-ttu-id="0f1d5-435">Windows Phone -> `Microsoft.Devices.Sensors`</span><span class="sxs-lookup"><span data-stu-id="0f1d5-435">WindowsPhone -> `Microsoft.Devices.Sensors`</span></span>
