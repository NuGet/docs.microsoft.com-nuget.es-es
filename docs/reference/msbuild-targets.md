...
| licencia | PackageLicenseFile | vacío | Se corresponde con `<license type="file">`. Debe empaquetar explícitamente el archivo de licencia al que se hace referencia. |
