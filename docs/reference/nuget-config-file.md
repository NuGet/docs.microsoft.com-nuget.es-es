...
Comportamiento de NuGet se controla mediante la configuración en diferentes `NuGet.Config` archivos como se describe en [configuraciones comunes NuGet](../consume-packages/configuring-nuget-behavior.md).
